// AeroShards:WebGPU 风动碎屑背景(React Bits 开源组件,github.com/DavidHDev/react-bits,MIT)
...
const parseColor = (value: string, fallback: string): Color => {
  ...
  const source = match || HEX_RE.exec(fallback)!;
  return [
      ...
      try {
        ...
        const scheduleFrame = (timestamp: number) => {
          ...
          const missedDeadline =
            Number.isFinite(sincePresentation) && sincePresentation > presentationInterval * 1.65;
